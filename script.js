...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Dec 23, 2023 00:00:00').getTime(),
  x = setInterval(function () {
    ...
    if (distance < 0) {
      ...
      confetti();
      setTimeout(function(){
        new Audio("./Assets/confetti.mp3").play();
      }, 100);
      clearInterval(x);
      _slideSatu();
    }
...
new TypeIt("#teks1", {
  strings: ["Assalamualaikum Wr. Wb.", " ", "Saya Aldi Pratama pada hari ini Sabtu, 23 Desember 2023 dengan sepenuh hati mengucapkan", " ", "<b>Selamat Ulang Tahun Yang ke - 20</b>", " ", "Kepada Anissa Nursafitri, semoga kamu panjang umur, dan bahagia selalu. Aamiin. Sekian surat pernyataan dari saya", , " ", "Wassalamualakaikum Wr. Wb.", " ", "- Aldi Pratama, Cimahi"],
  startDelay: 4000,
  speed: 75,
...
function confetti() {
  ...
  // setTimeout(playAudioConfetti, 500);
};
